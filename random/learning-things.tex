...
\begin{itemize}
    ...
    \item fsms are good for LTL and temporal logic. we already have smt for model checking. for temporal properties (which, crucially, are very important for hw) buechi automata are our best shot. 
        ...
        having this in a framework that is by design modular and reusability oriented is a great combo because we can exploit all the algorithm that enable to easily manipulate automata (a well scoped and known problem)
        and this would make our life easier 
\end{itemize}
